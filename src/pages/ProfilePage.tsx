    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pb-20 md:pb-0">
      <div className="container mx-auto px-4 py-6 md:py-8 max-w-4xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
          <Card className="border-2 border-gray-100">
            <CardContent className="p-3 md:p-4 text-center">
              ...
              <p className="text-lg md:text-2xl font-bold">{loyalty?.totalPoints || 0}</p>
          ...
          <Card className="border-2 border-gray-100">
            <CardContent className="p-3 md:p-4 text-center">
              ...
              <p className="text-lg md:text-2xl font-bold">{completedOrders}</p>
          ...
          <Card className="border-2 border-gray-100">
            <CardContent className="p-3 md:p-4 text-center">
              ...
              <p className="text-lg md:text-2xl font-bold">{referralStats.completedReferrals}</p>
          ...
          <Card className="border-2 border-gray-100">
            <CardContent className="p-3 md:p-4 text-center">
              ...
              <p className="text-lg md:text-2xl font-bold">{redeemableCoupons}</p>
            ...
            <CardContent className="p-4">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-green-800">You have {redeemableCoupons} coupon{redeemableCoupons > 1 ? 's' : ''} available!</p>
                    <p className="text-sm text-green-600">Each coupon gives ₹100 off on your next order</p>
                  </div>
                </div>
                <Button 
        ...
        <Tabs defaultValue="profile" className="space-y-4">
          <TabsList className="bg-white border-2 border-gray-200 h-auto p-1 flex-wrap rounded-xl w-full grid grid-cols-4">
            <TabsTrigger
              value="profile"
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="font-semibold text-gray-900 mt-1">{profileData.phone || 'Not provided'}</p>
                  )}
                </div>
                <div>
                ...
                {orders.length === 0 ? (
                  ...
                  <div className="space-y-3 max-h-[400px] overflow-y-auto">
                    {orders.slice(0, 10).map((order) => (
                      <div
                        key={order.id}
                        className="flex flex-col md:flex-row md:items-center justify-between p-3 md:p-4 bg-gray-50 rounded-xl gap-2"
                      >
                        <div className="flex items-center gap-3">
