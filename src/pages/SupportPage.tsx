          ...
          {isLoading ? (
            ...
            <Card className="border-2 border-dashed border-gray-200">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-500 mb-4">Create a ticket if you need help with anything</p>
              ...
              {tickets.map((ticket) => (
                <Card 
                  ...
                  className={`border-2 transition-all ${
                    expandedTicket === ticket.id ? 'border-teal-300' : 'border-gray-200'
                  }`}
                >
                  <CardContent className="p-4">
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500 capitalize">{ticket.category.replace('_', ' ')}</p>
                      </div>
